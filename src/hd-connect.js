...
export const PENTA_CHANNELS = [
  { key: '7-31',  gates: [31, 7],  zh: '对外领导',  roles: { 31: '对外发声', 7: '内部领导' } },
  { key: '1-8',   gates: [8, 1],   zh: '创意示范',  roles: { 8: '示范推广', 1: '创意方向' } },
  { key: '13-33', gates: [33, 13], zh: '复盘传承',  roles: { 33: '经验传承', 13: '倾听复盘' } },
  { key: '5-15',  gates: [15, 5],  zh: '节奏流程',  roles: { 15: '场域节奏', 5: '固定流程' } },
  { key: '2-14',  gates: [2, 14],  zh: '资源方向',  roles: { 2: '资源把关', 14: '资源动力' } },
  { key: '29-46', gates: [46, 29], zh: '承诺坚持',  roles: { 46: '推进完成', 29: '承诺投入' } },
];
